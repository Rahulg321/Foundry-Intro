...
contract MyToken{
    ...
    function mintTo(address _to,uint _amount) onlyOwner public  {
    ...
    function transfer(address _to,uint _amount) public {
        require(balances[msg.sender] >= _amount, "does not have balance to send eth");
        balances[_to] += _amount;
    }
    ...
    function transferFrom(address _from, address _to, uint _value) public {
        ...
        require(allowance >= _value, "You dont have enough allowance to send to that person");

        require(balances[_from] >= _value, "from account does not enough balance");
